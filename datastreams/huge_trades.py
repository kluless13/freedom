...
symbols = [
    'btcusdt', 'ethusdt', 'solusdt', 'wifusdt',  # existing ones
    'bnbusdt', 'xrpusdt', 'adausdt', 'maticusdt', 'dotusdt', 
    'ltcusdt', 'dogeusdt', 'shibusdt', 'avaxusdt', 
    'linkusdt', 'uniusdt', 'trxusdt', 'xlmusdt'
]
